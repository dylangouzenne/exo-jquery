...
// var titre=books["title"];
// var auteur=books["author"];
// var lien=books["link"];
// var langage=books["type"];

for (var i =0; i<books.length; i++) {
  $("#tableau").append("<ul><li>"+books[i].title+"</li><li>"+books[i].author+"</li><li>"+books[i].link+"</li><li>"+books[i].type+"</li></ul>");
}